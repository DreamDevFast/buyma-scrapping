    ...
    <div class="body_scroll">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12" style="height:max-content">                           
                            <select id="brands" class="form-control show-tick ms select2" name="brands[]" multiple data-placeholder="Select"  style="height:max-content"> 
                            ...
                            <table class="table table-hover product_item_list c_table theme-color mb-0">
                                ...
                                @foreach($products as $product)
                                    <tr>
                                        ...
                                        <td style="white-space:normal"><h5>{{$product->name}} - {{$product->product_name}}</h5></td>
