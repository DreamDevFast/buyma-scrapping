        ...
        <div class="block-header">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">                
                    ...
                    <button class="btn btn-warning btn-icon float-right" type="button" title="出品"  onclick="exhibit_burberry_product()"><i class="zmdi zmdi-upload"></i></button>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="body"> 
                            ...
                            ?>
                                <li class="page-item <?php if($now_page == $i)echo 'active';?>"><a class="page-link" href="./burberry?skeyword=<?=$skeyword?>&page=<?=$i?>"><?=$i?></a></li>
                            ...
                            <?php }
                                ...
                                if($now_page < 8){
                                    ...
                                    <?php if($end_page >= 7){?>
                                        <li class="page-item"><a class="page-link" href="./burberry?skeyword=<?=$skeyword?>&page=6">...</a></li>
                                        <li class="page-item"><a class="page-link" href="./burberry?skeyword=<?=$skeyword?>&page=<?=($end_page)?>"><?=($end_page)?></a></li>
                                        <li class="page-item"><a class="page-link" href="./burberry?page=<?=($now_page + 7)?>&skeyword=<?=$skeyword?>"><i class="zmdi zmdi-arrow-right"></i></a></li>
                                    <?php } else{?>
                                        <li class="page-item"><a class="page-link" href="./burberry?skeyword=<?=$skeyword?>&page=6?>">6</a></li>
                                        <li class="page-item"><a class="page-link" href="./burberry?skeyword=<?=$skeyword?>&page=7?>">7</a></li>
                                    <?php }?>

                                    <?php
                                }else if($now_page > $end_page - 7){
                                    ?>
                                    <li class="page-item"><a class="page-link" href="./burberry?skeyword=<?=$skeyword?>&page=<?=($end_page - 7)?>"><i class="zmdi zmdi-arrow-left"></i></a></li>
                                    <?php
                                    ...
                                    <li class="page-item"><a class="page-link" href="./burberry?skeyword=<?=$skeyword?>&page=<?=($now_page - 7)?>"><i class="zmdi zmdi-arrow-left"></i></a></li>
                                    
                                    <li class="page-item"><a class="page-link" href="./burberry?skeyword=<?=$skeyword?>&page=1">1</a></li>
                                    <li class="page-item"><a class="page-link" href="./burberry?skeyword=<?=$skeyword?>&page=<?=($now_page-2)?>">...</a></li>                                            
                                    <li class="page-item"><a class="page-link" href="./burberry?skeyword=<?=$skeyword?>&page=<?=($now_page-1)?>"><?=($now_page-1)?></a></li>
                                    <li class="page-item active"><a class="page-link" href="./burberry?skeyword=<?=$skeyword?>&page=<?=($now_page)?>"><?=($now_page)?></a></li>
                                    <li class="page-item"><a class="page-link" href="./burberry?skeyword=<?=$skeyword?>&page=<?=($now_page+1)?>"><?=($now_page+1)?></a></li>  
                                    <li class="page-item"><a class="page-link" href="./burberry?skeyword=<?=$skeyword?>&page=<?=($now_page+2)?>">...</a></li>                                      
                                    ...
                                    <?php if($end_page >= ($now_page + 3)){?>
                                        ...
                                        <li class="page-item"><a class="page-link" href="./burberry?page=<?=($now_page + 7)?>&skeyword=<?=$skeyword?>"><i class="zmdi zmdi-arrow-right"></i></a></li>
                                    <?php } else{?>
                                        <li class="page-item"><a class="page-link" href="./burberry?skeyword=<?=$skeyword?>&page=<?=($now_page+3)?>"><?=($now_page+3)?></a></li>
                                    <?php }?>
                            <?php 
                                }
                            }
